 ...
 */
function RadrdNetworkError(message) {
  this.message = message !== void(0) ? message : 'Cannot connect to radrd';
}
RadrdNetworkError.prototype = new NetworkError;
RadrdNetworkError.prototype.error = 'restRADRD_NETWORK_ERR';
...
module.exports = {
  ...
  RadrdNetworkError: RadrdNetworkError,
