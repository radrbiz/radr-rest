 ...
 *
 * @param {Radr Transaction in JSON Format} notification_details.transaction
 * @param {RadrAddress} notification_details.account
...
NotificationParser.prototype.parse = function(notification_details) {
  ...
  notification.timestamp = new Date(
    radr.utils.time.fromRipple(transaction.date)
  ).toISOString();
